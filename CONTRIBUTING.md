# Contributing to Hammer Backend Mnesia
...
making it easier for developers to [contribute to Hammer Backend Mnesia](#pull-requests).
...
your Operating System, as well as your Erlang, Elixir and Hammer Backend Mnesia versions. Please provide steps to
...
1. [Fork](https://help.github.com/articles/fork-a-repo/) the project, clone your fork,
   ...
   git clone https://github.com/<your-username>/hammer-backend-mnesia

   # Navigate to the newly cloned directory
   cd hammer-backend-mnesia

   # Assign the original repo to a remote called "upstream"
   git remote add upstream https://github.com/ExHammer/hammer-backend-mnesia
   ```
